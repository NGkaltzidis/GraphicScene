...
private:
	...
	D3DXMATRIX m_ViewProjMatrix = m_ViewMatrix * m_ProjMatrix; // Combine (multiply) the view and projection matrices together - saves a matrix multiply in the shader (optional optimisation)
